...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size',required=True,type=int,default=64,help='train/val batch size,default is 64')
    parser.add_argument('--seq_len',required=True,type=int,default=17,help='the sequence length effected by image width')
    parser.add_argument('--num_label',required=True,type=int,default=9,help='output label length,must less than seq_len')
    parser.add_argument('--imgH',required=True,type=int,default=32,help='image height,must divided by 16')
    parser.add_argument('--imgW',required=True,type=int,default=200,help='image width')
    ...
    parser.add_argument('--gpu',type=bool,action='store_true',help='enable train with gpu(0)')
    parser.add_argument('--from_epoch',type=int,action='store_true',help='continue train from specific epoch file')
